...
module.exports = {
    ...
    authorize: Promise.method(function authorize(v) {
        if (v.request.authorization.scheme === undefined && v.permissions._anonymous_ === undefined)
            throw new restify_errors.UnauthorizedError("Not authorized, anonymous access prohibited.");
        if (v.request.authorization.scheme !== 'Basic')
            throw new restify_errors.UnauthorizedError("Only Basic authentication is implemented right now.");
    ...
    find_botuser: Promise.method(function find_botuser(v) {
        ...
        try {
            ...
            throw new restify_errors.InternalError(e.message);
        }

        if (!passmatch)
            throw new restify_errors.UnauthorizedError("Not authorized. #2");
    ...
    find_ldapuser: Promise.method(function find_ldapuser(v) {
        ...
        if (v.config.ldap === undefined)
            throw new restify_errors.UnauthorizedError("Not authorized. #3");
        ...
        .then(function() {
            ...
            if (e.name === 'OperationalError' && e.message.indexOf('no such user: "') === 0)
                return v;
            throw new restify_errors.InternalError("LDAP connection failed.");
        }).finally(function(){
            ldap.close(function() {});
        });
    }),
    find_config_flags: Promise.method(function find_config_flags(v) {
        if (v.username === undefined)
            throw new restify_errors.UnauthorizedError("Not authorized. #5");
    ...
    find_database_flags: Promise.method(function find_database_flags(v) {
        if (v.username === undefined)
            throw new restify_errors.UnauthorizedError("Not authorized. #6");
    ...
    impersonate: Promise.method(function impersonate(v) {
        if (v.username === undefined)
            throw new restify_errors.UnauthorizedError("Not authorized. #7");
        ...
        if (v.flags.indexOf('_admin_') < 0 &&
            ...
            throw new restify_errors.UnauthorizedError("Not authorized. #8");
    ...
    effective_permissions: Promise.method(function effective_permissions(v) {
        ...
        if (v.permission === undefined)
            throw new restify_errors.ForbiddenError("The link you followed is either outdated, inaccurate, or the server has been instructed not to let you have it.");
